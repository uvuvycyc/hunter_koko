...
function checkRU($mail){
  ...
  curl_setopt($ch,CURLOPT_HTTPHEADER, [
    'Host: auth.mail.ru',
'Connection: keep-alive',
'User-Agent: Mozilla/5.0 (Linux; Android 10; Infinix X690B Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/94.0.4606.61 Mobile Safari/537.36',
'Accept: */*',
...
curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Safari/537.36"); 
...
$c = curl_init("https://login.yahoo.com/"); 
curl_setopt($c, CURLOPT_FOLLOWLOCATION, true); 
curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.72 Safari/537.36"); 
...
function check_ban($gmail){
    ...
    $header = array(); 
    $header[] = "User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0.1 Safari/605.1.15"; 
    $header[] = "content-type: application/json; charset=utf-8"; 
    $c = curl_init("https://accounts.google.com/InputValidator?resource=SignUp&service=mail"); 
    curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0.1 Safari/605.1.15"); 
    curl_setopt($c, CURLOPT_HTTPHEADER, $header); 
...
class ig {
	...
	public function __construct($settings){
		...
		$this->account['useragent'] = 'Instagram 84.0.522.52 Android (23/6.0.1; 640dpi; 1440x2392; LGE/lge; RS988; h1; h1; en_US)';
